/**
 * Canonical FIVB-style rules content, seeded into Postgres by the backend and
 * used directly by the static demo build. Kept in shared-types so the API and
 * the demo can never drift apart.
 */
